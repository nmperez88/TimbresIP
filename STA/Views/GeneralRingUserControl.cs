...
namespace STA
{
    partial class GeneralRingUserControl : BaseUserControl
    {
        ...
        {
            String[] columnsToJump = new String[] { "ColumnCall", "observationsDataGridViewTextBoxColumn", "startAtDataGridViewTextBoxColumn", "ColumnEndCall", "modeDataGridViewTextBoxColumn" };
            return isValid(dataGridViewGeneralSound, columnsToJump);
        }
        #endregion
